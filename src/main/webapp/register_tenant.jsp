...
<body>
			...
			<div class="col-md-6 col-lg-4">
				<form class="form-login">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="dni" name="dni" placeholder="Ingrese su cédula" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="telephone" name="telephone" placeholder="Ingrese su telefono" required>
					</div>
					<div class="form-group">
	...
	<script src="../js/register_tenant.js" type="module"></script>
</body>
</html>