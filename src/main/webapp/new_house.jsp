...
<body>
	<header>
		<a href="./houses"><i class="fa-solid fa-circle-left"></i></a> <h3>Casa</h3>
	</header>
	...
	<main>
		<div class="d-grid">
			<form>
				...
				<div>
					<label for="selec-status">Estado</label> <select name="status"
				...
				<div>
					...
					<input type="file" multiple id="images" name="images[]" required>
				</div>
				<div>
